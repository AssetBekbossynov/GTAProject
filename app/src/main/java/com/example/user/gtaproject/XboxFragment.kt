...
class XboxFragment: Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        title.text = getString(R.string.gtav_xbox_title)

        div1.div_title.text = "Оружие"
        div1.cheats.text = getString(R.string.gtav_xbox_weapons)
        ...
        div2.cheats.text = getString(R.string.gtav_xbox_gameplay)
        ...
        div3.cheats.text = getString(R.string.gtav_xbox_vehicle)
