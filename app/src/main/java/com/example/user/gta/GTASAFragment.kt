...
class GTASAFragment: Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        title.text = getString(R.string.gtasa_title)

        div1.div_title.text = "Оружие"
        div1.cheats.text = getString(R.string.gtasa_weapons)
        ...
        div2.cheats.text = getString(R.string.gtasa_gameplay)
        ...
        div3.cheats.text = getString(R.string.gtasa_vehicle)
        ...
        instructions.text = getString(R.string.gtasa_instructions)
    }
