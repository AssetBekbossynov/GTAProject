...
class GTAIVBalladFragment: Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        title.text = getString(R.string.gtaiv_ballad_title)

        div1.div_title.text = "Оружие"
        div1.cheats.text = getString(R.string.gtaiv_ballad_weapons)
        ...
        div2.cheats.text = getString(R.string.gtaiv_ballad_gameplay)
        ...
        div3.cheats.text = getString(R.string.gtaiv_ballad_vehicle)
        ...
        div4.cheats.text = getString(R.string.gtaiv_ballad_unique)
